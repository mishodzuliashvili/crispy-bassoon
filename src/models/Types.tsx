export type RentType = { name: string; id: number; value: number };
export type SortType = { name: string; id: number; value: number };
export type PeriodType = { name: string; id: number; value: string };
export type PriceFromType = number;
export type PriceToType = number;
...
export type AugmentedMansModelsType = {
  man_id: string;
  models: (
...
export type SearchType = {
  ForRent?: RentType["value"];
  MansWithModels?: AugmentedMansModelsType[];
  Cats?: CatsType["category_id"][];
